package crc6481ac171de3136edd;


public class AluminListeners
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("XamarinFirebase.EventListeners.AluminListeners, XamarinFirebase", AluminListeners.class, __md_methods);
	}


	public AluminListeners ()
	{
		super ();
		if (getClass () == AluminListeners.class) {
			mono.android.TypeManager.Activate ("XamarinFirebase.EventListeners.AluminListeners, XamarinFirebase", "", this, new java.lang.Object[] {  });
		}
	}
